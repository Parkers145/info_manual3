...
- <details><summary>What is the start and end of the current minting period? What are the minting periods for Threefold Farming in 2023?</summary>&nbsp;
    ...
    |_________-|_________________________________|_________________________________|
...
- <details><summary>One of my nodes is showing the wrong location. Any problem with that?</summary>
